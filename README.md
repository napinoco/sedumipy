...
Windows x64, and macOS (Apple silicon and Intel); Windows ARM64 is
CPython 3.11-3.13 only, since numpy/scipy publish no win_arm64 wheel
for 3.10. All of them have the compiled kernel library and its BLAS
already inside — no compiler, no BLAS install, no MATLAB or Octave.
